	...
	tests := []struct {
	...
	}{
		{
			...
			result: AttestationPolicy{
				...
				EnsureDependenciesPinned:    true,
				AllowedUnpinnedDependencies: []Dependency{},
				EnsureCodeReviewed:          true,
				ReviewRequirements:          CodeReviewRequirements{MinReviewers: 1},
			},
		},
		{
		...
		},
		{
			...
			result: AttestationPolicy{
				...
				EnsureNoVulnerabilities:     false,
				EnsureDependenciesPinned:    false,
				AllowedUnpinnedDependencies: []Dependency{{Filepath: "Dockerfile"}},
				EnsureCodeReviewed:          true,
				ReviewRequirements:          CodeReviewRequirements{RequiredApprovers: []string{"alice"}, MinReviewers: 2},
			},
		},
		{
